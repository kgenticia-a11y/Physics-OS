...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-background to-purple-50 dark:from-indigo-950/30 dark:via-background dark:to-purple-950/30 px-4 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-500/10 rounded-full blur-3xl animate-blob-delay-1" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="border-0 shadow-2xl shadow-black/5 dark:shadow-black/30">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Start building your physics intuition</CardDescription>
          </CardHeader>
